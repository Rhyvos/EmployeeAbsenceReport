#ifndef SENIORCALCULATIONSTRATEGY_H
#define SENIORCALCULATIONSTRATEGY_H
...
class SeniorCalculationStrategy : public ICalculationStrategy {
 private:
  std::string _from;
  std::string _to;

 public:
  SeniorCalculationStrategy(std::string from, std::string to)
      : _from(from), _to(to) {}
...
#endif // SENIORCALCULATIONSTRATEGY_H